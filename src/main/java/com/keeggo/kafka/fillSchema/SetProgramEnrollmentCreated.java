...
import br.com.kroton.program_enrollment_created;

public class SetProgramEnrollmentCreated {

	public static final String TOPIC = new String("program-enrollment-created");
	
	public ProducerRecord<String, Object> setSchema(){
	
	program_enrollment_created programEnrollmentCreated = program_enrollment_created.newBuilder()
	...
	System.out.println(programEnrollmentCreated);
